...
public class TryingMain {
    public static void main(String[] args) throws IOException, IncorrectValueException {
        ...
        String cuisineString=new Cuisine.Builder().setTitle("title1").build().toStringTXT()+
                new Cuisine.Builder().setTitle("title2").build().toStringTXT();
        ...
        String compositionString=new CompositionOfRecipe.Builder().setId("ID1")
                .setIngredientId("iid1").setAmountOfIngredient(123).setValueId("v1").setRecipeId("Rid1").build().toStringTXT()+ "\n"+
                new CompositionOfRecipe.Builder().setId("ID2").setIngredientId("iid2")
                        .setAmountOfIngredient(4).setValueId("v2").setRecipeId("Rid2").build().toStringTXT();
